  ...
  children: [
    {
      ...
      component: () =>
        import('@/views/examinationSystemTable/queryReviewListMaxismTable.vue'),
    ...
    },
    {
      ...
      component: () =>
        import('@/views/examinationSystemTable/queryReviewListAllTable.vue'),
    ...
    },
    {
      ...
      component: () =>
        import('@/views/examinationSystemTable/queryNationLineTable.vue'),
    ...
    },
    {
      ...
      component: () =>
        import('@/views/examinationSystemTable/queryCollegeLineTable.vue'),
    ...
    },
    {
      ...
      component: () =>
        import('@/views/examinationSystemTable/queryAcademyLineTable.vue'),
    ...
    },
    {
      path: 'addAcademyLine',
      component: () =>
        import('@/views/examinationSystemTable/addAcademyLine.vue'),
      name: 'addAcademyLine',
      meta: { title: '新增院线' }
    },
    {
      ...
      component: () =>
        import(
          '@/views/examinationSystemTable/queryAcademyGenerateScoreTable.vue'
        ),
    ...
    },
    {
      ...
      component: () =>
        import('@/views/examinationSystemTable/queryCollegeTable.vue'),
