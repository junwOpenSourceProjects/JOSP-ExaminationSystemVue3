      ...
      <el-main>
        ...
        <el-table :data="tabledata" style="width: 100%" stripe>
          ...
          <el-table-column
            ...
            ><template slot-scope="scope">
              <el-tag
                :type="
                  scope.row.table_priority === 'normal' ? 'primary' : 'danger'
                "
              >
          ...
          >
            <template>
              <el-button size="mini" @click="cover_dialog = true"
                >修改封面</el-button
              >
              <br />
              <el-button size="mini" @click="article_download"
                >文本下载</el-button
              >
            </template>
          </el-table-column>
          ...
          >
            <template>
              <el-button-group>
                ...
                <el-button size="mini" @click="audio_dialog = true"
                  >配音修改</el-button
                >
                <br />
                <el-button size="mini" @click="audio_download"
                  >配音下载</el-button
                >
              </el-button-group>
            </template>
          ...
          >
            <template>
              <el-button-group>
                <el-button size="mini" @click="cutter_dialog = true"
                  >剪辑修改</el-button
                >
                <br />
                <el-button size="mini" @click="video_download"
                  >剪辑下载</el-button
                >
              </el-button-group>
            </template>
            ...
            <template slot-scope="scope">
              <el-popover trigger="hover" placement="top">
                ...
                <div slot="reference" class="name-wrapper">
                  <el-button size="mini" @click="reviews_dialog = true"
                    >人工审核
                  </el-button>
                </div>
              </el-popover>
          ...
          <el-table-column
            ...
            ><template>
              <el-button-group>
                <el-button size="mini" @click="machine_reviews_result = true"
                  >机器审核</el-button
                >
          ...
          <el-table-column
            ...
            ><template>
              <el-button-group>
                <el-button size="mini" @click="choose_plateform = true"
                  >平台选择</el-button
                >
                <!-- <el-button size="mini">剪辑下载</el-button> -->
              </el-button-group>
          ...
          >
            ...
            <template>
              ...
              <br> -->
              <el-button type="primary" plain @click="table_query"
                >发布视频</el-button
              >
            </template>
          </el-table-column>
        ...
        <el-dialog title="机器审核" :visible.sync="machine_reviews_result">
          <el-form>
            <el-form-item label="机审操作：">
              ...
              <el-button @click="refresh_machine_result"
                >刷新机审结果
              </el-button>
            </el-form-item>
            ...
            <el-form-item label="终审意见：">
              <el-radio-group>
                ...
                <el-button @click="give_final_advertise"
                  >给出终审意见</el-button
                >
              </el-radio-group>
        ...
        <el-dialog title="平台选择" :visible.sync="choose_plateform">
          ...
          <el-form>
            ...
            <el-button type="primary" plain @click="check_plate_choose"
              >提交</el-button
            >
