      ...
      <el-row :gutter="15">
        <el-col :span="24" style="width: 100%">
          <el-row :gutter="15">
              ...
              <el-row :gutter="15">
                <el-col :span="24" style="width: 100%">
                  <el-row :gutter="15">
                    <el-col :span="24" style="width: 33%">
                      <el-row :gutter="15">
                        <el-col
                          v-if="formModelControl.field113.isShow"
                          :span="24"
                          :offset="0"
                        >
                    ...
                    <el-col :span="24" style="width: 33%">
                      <el-row :gutter="15">
                        <el-col
                          v-if="formModelControl.field115.isShow"
                          :span="24"
                          :offset="0"
                        >
                    ...
                    <el-col :span="24" style="width: 33%">
                      <el-row :gutter="15">
                        <el-col
                          v-if="formModelControl.field118.isShow"
                          :span="24"
                          :offset="0"
                        >
                ...
                <el-col :span="24" style="width: 100%">
                  <el-row
                    ...
                    align="middle"
                    :gutter="15"
                    style="flex-direction: row; text-align: center"
                  >
                    <el-col
                      v-if="formModelControl.field109.isShow"
                      :span="24"
                      :offset="0"
                    >
                ...
                <el-col :span="24" style="width: 100%">
                  <el-row :gutter="15">
                    ...
                    >
                      ...
                      >
                        <el-table-column
                          v-for="(th, key) in formModelControl.field107
                            .tableHeader"
                          :key="key"
            ...
            <div id="mychar2" class="echartDemo" />
          </el-row>
        </el-col>
      </el-row>
    </el-form>
      ...
      var option2 = {
        ...
        series: [
          ...
          },
          {
            ...
            data: [
              3.9, 4.9, 9.1, 12.7, 22.3, 43.2, 211.6, 4.6, 53.4, 18.4, 10.3,
              0.7,
            ],
          },
          {
