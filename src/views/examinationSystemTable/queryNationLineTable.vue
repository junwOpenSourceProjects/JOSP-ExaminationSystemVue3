    ...
    <el-dialog :title = "textMap[dialogStatus]" :visible.sync = "dialogFormVisible">
      ...
      >
        <el-form-item label = "国家线主键" prop = "id">
          <el-input placeholder = "请输入国家线主键 primary key" v-model = "temp.id" :disabled = "true"></el-input>
        </el-form-item>
        <el-form-item label = "学科类型" prop = "subjectClass">
          <el-input placeholder = "请输入学科类型" v-model = "temp.subjectClass" :disabled = "true"></el-input>
        </el-form-item>
        <el-form-item label = "ab类学生" prop = "studentClass">
          <el-input placeholder = "请输入ab类学生" v-model = "temp.studentClass" :disabled = "true"></el-input>
        </el-form-item>
        <el-form-item label = "政治国家线" prop = "scorePolite">
          <el-input placeholder = "请输入政治国家线" v-model = "temp.scorePolite" :disabled = "true"></el-input>
        </el-form-item>
        <el-form-item label = "英语国家线" prop = "scoreEnglish">
          <el-input placeholder = "请输入英语国家线" v-model = "temp.scoreEnglish" :disabled = "true"></el-input>
        </el-form-item>
        <el-form-item label = "专业课一国家线" prop = "scoreProfessional1">
          <el-input placeholder = "请输入专业课一国家线" v-model = "temp.scoreProfessional1"
                    :disabled = "true"></el-input>
        </el-form-item>
        <el-form-item label = "专业课二国家线" prop = "scoreProfessional2">
          <el-input placeholder = "请输入专业课二国家线" v-model = "temp.scoreProfessional2"
                    :disabled = "true"></el-input>
        </el-form-item>
        <el-form-item label = "总分国家线" prop = "scoreTotal">
          <el-input placeholder = "请输入总分国家线" v-model = "temp.scoreTotal" :disabled = "true"></el-input>
        </el-form-item>
        <el-form-item label = "公共课总分国家线" prop = "scoreTotalPublic">
          <el-input placeholder = "请输入公共课总分国家线" v-model = "temp.scoreTotalPublic"
                    :disabled = "true"></el-input>
        </el-form-item>
        <el-form-item label = "专业课总分国家线" prop = "scoreTotalProfessional">
          <el-input placeholder = "请输入专业课总分国家线" v-model = "temp.scoreTotalProfessional"
                    :disabled = "true"></el-input>
        </el-form-item>
      </el-form>
