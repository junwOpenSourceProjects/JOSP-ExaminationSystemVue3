import process from 'node:process';globalThis._importMeta_=globalThis._importMeta_||{url:"file:///_entry.js",env:process.env};import { defineComponent, ref, shallowRef, watch, h, hasInjectionContext, inject, getCurrentInstance, nextTick, defineAsyncComponent, computed, unref, provide, shallowReactive, Suspense, Fragment, createApp, onErrorCaptured, onServerPrefetch, createVNode, resolveDynamicComponent, reactive, effectScope, mergeProps, getCurrentScope, toRef, withCtx, isReadonly, useSSRContext, isRef, isShallow, isReactive, toRaw } from 'vue';
import http from 'node:http';
import https from 'node:https';
import { F as withBase, j as destr, G as withQuery, s as i, B as s, w as l$1, c as createError$1, z as parseURL, k as encodePath, d as decodePath, r as hasProtocol, t as isScriptProtocol, u as joinURL, H as withQuery$1, v as klona, C as sanitizeStatusCode, h as defuFn, m as getContext, b as baseURL, f as defu, g as defu$1, l as executeAsync } from '../nitro/nitro.mjs';
...
const unhead_n6yR4p_KJSl70bVGeTg3vg7gAVzDVZYjNlRggTV3z7Q = /* @__PURE__ */ defineNuxtPlugin({
  name: "nuxt:head",
  enforce: "pre",
  setup(nuxtApp) {
...
const _routes = [
  {
    name: "index",
    path: "/",
    component: () => import('./index-DCwBxAvx.mjs')
  }
];
...
const revive_payload_server_QBWeZgEo5X7gsGryMn7_Em94GpML8QIRWNydNAPdW3k = /* @__PURE__ */ defineNuxtPlugin({
...
const plugin_poxp_xiE9jvSTUikkpS99ggPGwAc7IOUnykm9oDD_Ho = /* @__PURE__ */ defineNuxtPlugin({
  name: "@nuxt/icon",
  setup() {
...
const LazyIcon = defineAsyncComponent(() => import('./index-CVLZuhy7.mjs').then((r) => r["default"] || r.default || r));
...
const colors_l2SBg1ILPnaz_PAChI0E_vdOBQ2V6xMGrp4rrb9C6tc = /* @__PURE__ */ defineNuxtPlugin(() => {
...
const plugins = [
  unhead_n6yR4p_KJSl70bVGeTg3vg7gAVzDVZYjNlRggTV3z7Q,
  plugin,
  revive_payload_server_QBWeZgEo5X7gsGryMn7_Em94GpML8QIRWNydNAPdW3k,
  plugin_server_XlivkfYBOcHtXydUVsxvbfczHZpJKCMwq769UkFyeKk,
  plugin_poxp_xiE9jvSTUikkpS99ggPGwAc7IOUnykm9oDD_Ho,
  components_plugin_4kY4pyzJIYX99vmMAAIorFf3CnAaptHitJgf7JxiED8,
  colors_l2SBg1ILPnaz_PAChI0E_vdOBQ2V6xMGrp4rrb9C6tc
];
const layouts = {
  default: defineAsyncComponent(() => import('./default-9uSLt3CG.mjs').then((m) => m.default || m))
};
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = defineAsyncComponent(() => import('./error-404-Du6j8TIC.mjs'));
    const _Error = defineAsyncComponent(() => import('./error-500-D6Ao1tGQ.mjs'));
...
_sfc_main$1.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("node_modules/.pnpm/nuxt@4.4.6_@babel+plugin-syntax-jsx@7.29.7_@babel+core@7.29.7__@babel+plugin-syntax-typ_461924d0aed8dce5172a6a79445de024/node_modules/nuxt/dist/app/components/nuxt-error-page.vue");
...
_sfc_main.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("node_modules/.pnpm/nuxt@4.4.6_@babel+plugin-syntax-jsx@7.29.7_@babel+core@7.29.7__@babel+plugin-syntax-typ_461924d0aed8dce5172a6a79445de024/node_modules/nuxt/dist/app/components/nuxt-root.vue");
...
export { Icon as I, _export_sfc as _, asyncDataDefaults as a, nuxtLinkDefaults as b, createError as c, useHead as d, entry_default as default, encodeRoutePath as e, useNuxtApp as f, getIcon as g, useRouter as h, useRuntimeConfig as i, loadIcon as l, navigateTo as n, resolveRouteObject as r, useAppConfig as u };
